...
- (void)maximizeStackViewAtIndex:(NSInteger)indexNumber
{
    ...
    objc_setAssociatedObject(self, kPSSVAssociatedStackViewControllerWantsFull, @YES, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)minimizeStackViewAtIndex:(NSInteger)indexNumber
{
    ...
    objc_setAssociatedObject(self, kPSSVAssociatedStackViewControllerWantsFull, @NO, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
